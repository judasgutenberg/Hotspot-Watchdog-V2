...
const int sensorType = 2301;//2301;//680; //SENSORS! -- we support these: 180 for BMP180, 2301 for DHT 2301, 680 for BMP680.  0 for no sensor.  No support for multiple sensors for now.
